...
<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1"  style="background-color:#fff">
  ...
  <li class="list-group-item" style="background-color:#808080; border:1px solid #000">
        <a class=".text-white" style="color:#fff" href="load.php"><b>Iniciar Consumo CPU</b></a>
    </li>
    <li class="list-group-item" style="background-color:#808080;border:1px solid #000">
      <a class=".text-white" style="color:#fff" href="stop-cpu.php">Parar Consumo CPU</a>
    </li>
  </ul>
</div>
